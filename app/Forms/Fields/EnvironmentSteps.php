...
use App\Utilities\EnvironmentHelp as UtilitiesEnvironmentHelp;
use Filament\Forms\Components\TextInput;
use Filament\Forms\Components\Wizard\Step;
use Shipu\WebInstaller\Concerns\StepContract;

class EnvironmentSteps implements StepContract
{
    ...
    public static function make(): Step
    {
        return Step::make('environment')
            ...
            ->beforeValidation(function ($state) {
                ...
                $environmentHelper = new UtilitiesEnvironmentHelp();
